...
import { Mail, Camera, Settings, Star, MapPin, X, ArrowRight } from 'lucide-react';
...
const INITIAL_COLLECTIONS = [
  {
    ...
    type: "Café",
    mood: "Peaceful",
    experience: "A cozy corner café with amazing latte art and freshly baked croissants. The ambient music and natural lighting make it perfect for both work and relaxation."
  },
  {
    id: 2,
    name: "Hidden Bar",
    ...
    type: "Bar",
    mood: "Lively",
    experience: "Speakeasy bar with creative cocktails and great atmosphere. The mixologist crafts unique drinks with local ingredients. Perfect for evening hangouts."
  },
  {
    id: 3,
    name: "Local Eatery",
    ...
    type: "Restaurant",
    mood: "Casual",
    experience: "Authentic street food experience with a modern twist. Famous for their pad thai and mango sticky rice. The place gets busy during dinner time."
  }
];
            ...
            <div className="p-8 md:w-2/3">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h1 className="text-3xl font-bold tracking-tight text-gray-900">{formData.fullName}</h1>
                  <button
                    onClick={() => {
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            {collections.slice(0, 2).map((place) => (
              <div key={place.id} className="transition-all bg-white shadow-sm rounded-xl hover:shadow-md group">
